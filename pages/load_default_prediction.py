...
class LoadDefaultPrediction(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Load Default Prediction")
        ...
        title_label = QLabel("Load Default Prediction")
        title_label.setAlignment(
            Qt.AlignmentFlag.AlignCenter)
        title_label.setStyleSheet("font-size: 24px; margin-bottom: 20px;")
        main_layout.addWidget(title_label)

        content_label = QLabel("Content of task 6...")
